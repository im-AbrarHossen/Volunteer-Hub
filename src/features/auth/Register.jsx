...
const Register = () => {
    ...
    return (
        <div>
            ...
            <main className="my-10 py-10 grid place-items-center">
                <div className="bg-base-100 shrink-0 shadow-2xl rounded-xl border">
                    <form onSubmit={handleSubmit} className="p-6">
                        ...
                        <div className="mt-5">
                            <p className="text-center text-[16px] font-[600] text-[#706F6F]">Already Have An Account ? <Link to="/login" className="text-[#FF8C47]">Login</Link> </p>
                        </div>
                    </form>
                </div>
            </main>
